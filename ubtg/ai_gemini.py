...
def generate_content(prompt: str | None = None, system_prompt: str | None = None, media: list[str] | None = None, model: str = 'gemini-2.0-flash', temperature: float = 1, api_key: str = GEMINI_API_KEY):
